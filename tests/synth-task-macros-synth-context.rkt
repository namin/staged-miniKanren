...
(record-bench 'synth/ground-context 'unstaged 'synth-append #:description "Portion of \\texttt{append} from examples as in \\cref{fig:rel-interp-solutions-to-sketch-and-backwards-run} (x100)")
(time-test
 #:times 100
 (run 1 (e)
